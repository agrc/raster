...
exports.toggleValueInList = toggleValueInList;
var xstate_1 = require("xstate");
/**
 * Determines initial state based on URL parameters or defaults
 */
function getInitialState(urlParams) {
    var allProductTypeKeys = [
        'aerialPhotography',
        'lidar',
        'usgsDem',
        'autoDem',
    ...
    var categoryFilter = (urlParams === null || urlParams === void 0 ? void 0 : urlParams.cat) || (urlParams === null || urlParams === void 0 ? void 0 : urlParams.catGroup) || null;
    if (categoryFilter) {
        return {
            context: {
    ...
    if ((urlParams === null || urlParams === void 0 ? void 0 : urlParams.products) && urlParams.products.length > 0) {
        var selectedProductTypes = urlParams.products
            .filter(function (index) { return index >= 0 && index < allProductTypeKeys.length; })
            .map(function (index) { return allProductTypeKeys[index]; });
        return {
            context: {
 ...
 */
function toggleValueInList(currentList, value) {
    if (currentList.includes(value)) {
        return currentList.filter(function (v) { return v !== value; });
    }
    else {
        return __spreadArray(__spreadArray([], currentList, true), [value], false);
    }
}
exports.machine = (0, xstate_1.setup)({
    ...
    guards: {
        hasProductTypes: function (_a) {
            var context = _a.context;
            return context.productTypes.length > 0;
        },
        hasAoi: function (_a) {
            var context = _a.context;
            return context.aoi !== null;
        },
        hasProductTypesAndAoi: (0, xstate_1.and)(['hasProductTypes', 'hasAoi']),
        hasDownload: function (_a) {
            var context = _a.context;
            return context.download !== null;
        },
    },
}).createMachine({
    id: 'wizardMachine',
    context: function (_a) {
        var _b;
        var input = _a.input;
        return (_b = input === null || input === void 0 ? void 0 : input.context) !== null && _b !== void 0 ? _b : getInitialState().context;
    },
    initial: 'step1',
    states: {
        step1: {
            on: {
                ...
                TOGGLE_PRODUCT_TYPE: {
                    actions: (0, xstate_1.assign)({
                        productTypes: function (_a) {
                            var context = _a.context, event = _a.event;
                            return toggleValueInList(context.productTypes, event.productType);
                        },
                        aoi: null,
                        download: null,
                    }),
