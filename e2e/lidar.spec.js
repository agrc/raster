...
test_1.test.describe('Lidar DEMs workflow', function () {
    (0, test_1.test)('should complete full workflow for lidar product', function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 2:
                    // Step 1: Select Lidar product type
                    _c.sent();
                    return [4 /*yield*/, page.getByRole('checkbox', { name: 'Lidar DEMs' }).check()];
                case 3:
                    _c.sent();
                    return [4 /*yield*/, (0, test_1.expect)(page.getByRole('checkbox', { name: 'Lidar DEMs' })).toBeChecked()];
                case 4:
                    _c.sent();
                ...
                case 7:
                    ...
                    return [4 /*yield*/, addressInput.fill('Provo, UT')];
                case 8:
                    _c.sent();
    ...
    (0, test_1.test)('should show lidar-specific metadata fields', function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
        var addressInput, productCard, moreInfoButton;
        var page = _b.page;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0: return [4 /*yield*/, page.goto('/')];
                ...
                case 4:
                    _c.sent();
                    addressInput = page.getByPlaceholder('Search for an address or place');
                    return [4 /*yield*/, addressInput.fill('Logan, UT')];
                case 5:
                    _c.sent();
                    return [4 /*yield*/, addressInput.press('Enter')];
                case 6:
                ...
                case 9:
                    _c.sent();
                    productCard = page.locator('[class*="Product"]').first();
                    return [4 /*yield*/, productCard.isVisible()];
                case 10:
                    if (!_c.sent()) return [3 /*break*/, 15];
                    moreInfoButton = productCard.getByRole('button', { name: /more info/i }).first();
                    return [4 /*yield*/, moreInfoButton.isVisible()];
                case 11:
                    if (!_c.sent()) return [3 /*break*/, 15];
                    return [4 /*yield*/, moreInfoButton.click()];
                case 12:
                    _c.sent();
                ...
                case 13:
                    ...
                    return [4 /*yield*/, (0, test_1.expect)(page.locator('text=/Year Collected|Vertical Accuracy/i').first()).toBeVisible({
                            timeout: 5000,
                        })];
                case 14:
                    // Verify lidar-specific fields like Year Collected, Vertical Accuracy
