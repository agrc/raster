...
test_1.test.describe('USGS DEMs workflow', function () {
    (0, test_1.test)('should complete full workflow for USGS DEM product', function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 7:
                    ...
                    return [4 /*yield*/, addressInput.fill('Moab, UT')];
                case 8:
                    _c.sent();
    ...
    (0, test_1.test)('should display USGS DEM metadata', function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 4:
                    _c.sent();
                    addressInput = page.getByPlaceholder('Search for an address or place');
                    return [4 /*yield*/, addressInput.fill('Park City, UT')];
                case 5:
                    _c.sent();
                    return [4 /*yield*/, addressInput.press('Enter')];
                case 6:
