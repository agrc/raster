...
test_1.test.describe('USGS Topo Maps (DRG) workflow', function () {
    (0, test_1.test)('should complete full workflow for DRG product', function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 2:
                    // Step 1: Select USGS Topo Maps product type
                    _c.sent();
                    return [4 /*yield*/, page.getByRole('checkbox', { name: 'USGS Topo Maps' }).check()];
                case 3:
                    _c.sent();
                    return [4 /*yield*/, (0, test_1.expect)(page.getByRole('checkbox', { name: 'USGS Topo Maps' })).toBeChecked()];
                case 4:
                    _c.sent();
                ...
                case 7:
                    ...
                    return [4 /*yield*/, addressInput.fill('Zion National Park, UT')];
                case 8:
                    _c.sent();
    ...
    (0, test_1.test)('should verify all 6 product types are available', function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
        var step2Button;
        var page = _b.page;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 7:
                    _c.sent();
                    step2Button = page.getByText('Step 2 - Define Area of Interest');
                    return [4 /*yield*/, (0, test_1.expect)(step2Button).toBeVisible()];
                case 8:
                    _c.sent();
                ...
                case 9:
                    ...
                    return [4 /*yield*/, step2Button.click()];
                case 10:
                    // Now step 2 should be accessible
                    _c.sent();
                    return [4 /*yield*/, (0, test_1.expect)(page.getByText('Step 2 - Define Area of Interest')).toBeVisible()];
