...
test_1.test.describe('Contours workflow', function () {
    (0, test_1.test)('should complete full workflow for contours product', function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 2:
                    // Step 1: Select Contours product type
                    _c.sent();
                    return [4 /*yield*/, page.getByRole('checkbox', { name: 'Contours' }).check()];
                case 3:
                    _c.sent();
                    return [4 /*yield*/, (0, test_1.expect)(page.getByRole('checkbox', { name: 'Contours' })).toBeChecked()];
                case 4:
                    _c.sent();
                ...
                case 7:
                    ...
                    return [4 /*yield*/, addressInput.fill('Cedar City, UT')];
                case 8:
                    _c.sent();
    ...
    (0, test_1.test)('should display contours on the map', function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
        var addressInput, mapContainer;
        var page = _b.page;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0: return [4 /*yield*/, page.goto('/')];
                ...
                case 4:
                    _c.sent();
                    addressInput = page.getByPlaceholder('Search for an address or place');
                    return [4 /*yield*/, addressInput.fill('Vernal, UT')];
                case 5:
                    _c.sent();
                    return [4 /*yield*/, addressInput.press('Enter')];
                case 6:
                ...
                case 9:
                    ...
                    return [4 /*yield*/, (0, test_1.expect)(mapContainer).toBeVisible({ timeout: 5000 })];
                case 10:
                    _c.sent();
                    return [2 /*return*/];
            }
